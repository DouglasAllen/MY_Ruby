...
The client side application JavaScript is contained in the file web/js/client_app.js. If you open this in your text editor you will see the following line, towards the
 top of the script:
