...
def equation_of_center
  1.9148 * sin(mean_anomaly * @d2r) +
    0.0200 * sin(2.0 * mean_anomaly * @d2r) +
    0.0003 * sin(3.0 * mean_anomaly * @d2r)
end
...
def julian_period_day_fraction_to_time(jpd_time)
  ...
  fraction = (jpd_fraction * 100_000_000.0).round / 100_000_000.0
  hours = Integer(fraction * 24.0)
  minutes = Integer((fraction - hours / 24.0) * 1440.0)
  seconds = Integer((fraction - hours / 24.0 - minutes / 1440.0) * 86_400.0)
